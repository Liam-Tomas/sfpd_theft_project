...
#     gdf[['geometry', 'Incident Category', 'Incident Date', 'Incident Time', 'Resolution', 'Police District', 'Incident Description']].to_file(filepath, driver='GeoJSON')
...
#         'robbery': df['Incident Category'] == 'Robbery',
#         'burglary': df['Incident Category'] == 'Burglary',
#         'car-robbery': df['Incident Category'] == 'Motor Vehicle Theft',
#         'prostitution': df['Incident Category'] == 'Prostitution',
#         'homicide': df['Incident Category'] == 'Homicide',
#         'disorderly': df['Incident Category'] == 'Disorderly Conduct',
#     }
...
def main():
    ...
    # Directory to save the files
    save_directory = '../frontend/sfpd_theft_app/public/clustermaps'
