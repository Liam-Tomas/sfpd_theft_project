...
import { categorizeRisk, getRiskCategoryColor } from '../sfpd_theft_app/src/components/charts/RiskUtils';
import styled from "styled-components";
import Button from '../sfpd_theft_app/src/components/utility/Button'; // Importing StyledButton
import Input from '../sfpd_theft_app/src/components/utility/Input'; // Importing StyledInput
import MainContainer from '../sfpd_theft_app/src/components/utility/MainContainer';
import RiskResultsModal from '../sfpd_theft_app/src/components/charts/RiskResultsModal';
...
function MentalRateCalc() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${api_route}/get_rate_mental_health`, { address: completeAddress });
    ...
    return <MainContainer>
        <h3>Relative Rate by Address Calculator</h3>
